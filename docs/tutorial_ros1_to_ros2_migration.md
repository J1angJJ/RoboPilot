...
- `.pytest_tmp/migration_plan.yaml`: static migration plan
- `.pytest_tmp/ros2_scaffold/`: conservative ROS2 scaffold placeholders
- `.pytest_tmp/scaffold_report.md`: Markdown validation report
