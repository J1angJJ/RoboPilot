...
RoboPilot's Python package and VSCode extension are versioned separately. The v2.0.x Python package release line uses its own package version; the Marketplace extension keeps its own version unless an extension release changes it.
