...
- `generate`：根据自然语言任务描述生成 ROS 风格 Python 包骨架，并离线选择合适模板。
...
RoboPilot 目前是早期 v0.2.0 MVP，重点是离线、轻量的机器人开发辅助流程。发布记录见 [`CHANGELOG.md`](CHANGELOG.md)。
