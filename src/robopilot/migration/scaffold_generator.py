...
def generate_migration_scaffold(
    ...
    *,
    ...
    files = _render_scaffold_files(preview)
...
def _render_scaffold_files(preview: MigrationScaffoldPreviewResult) -> dict[str, str]:
    files: dict[str, str] = {}
...
def _render_package_xml(preview: MigrationScaffoldPreviewResult) -> str:
    ...
    if preview.target_style in {"ament_cmake", "mixed_review_required"}:
